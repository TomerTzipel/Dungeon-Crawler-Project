...
namespace GameSystem
{
    public class Level
    {
        ...
        public Level(int matrixSectionSize, int numberOfSections,MapComposition mapComposition, Player player)
        {
        ...
        private void GenerateMapLayout(int numberOfSectionsToGenerate, int matrixSectionSize, MapComposition mapComposition, Player player)
        {

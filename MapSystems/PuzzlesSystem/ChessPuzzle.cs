...
namespace MapSystems
{
    ...
    {
        private const string CHESS_DIRECTORY_PATH = "..\\..\\..\\Puzzles\\Chess";
        ...
        private void GeneratePieces(string fileName)
        {
            ...
            for (int i = 2; i <= 9; i++)
            {
                for (int j = 2; j <= 9; j++)
                {
                    ...
                    ChessTileElement tile = (ChessTileElement)ElementAt(i, j);
        ...
        private void PlacePieceOnTile(ChessTileElement tile, string pieceData,Point position)
        {
        ...
        private void GenerateBoard()
        {
            ...
            for (int i = 0; i < Size; i++)
            {
                for (int j = 0; j < Size; j++)
                {
                    ...
                    AddElement(new ChessTileElement(tileColor), i, j);
        ...
        {
            if(_solver.WalkableElementOnTopOf is ChessTileElement tile)
            {
        ...
        {
            _solver = new PuzzleSolverElement();

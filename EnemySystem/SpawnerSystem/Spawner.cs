...
{
    public class Spawner : DestroyableElement, ITickable
    {
        ...
        public Spawner(Point position) : base(SPAWNER_EI)
        {
        ...
        private bool Spawn(Map map)
        {
            ...
            Enemy enemy = ChooseEnemyToSpawn(spawnPosition);
        ...
        private Enemy ChooseEnemyToSpawn(Point spawnPosition)
        {
